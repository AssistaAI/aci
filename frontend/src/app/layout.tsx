...
export default function RootLayout({
  ...
  return (
    <html lang="en" suppressHydrationWarning>
      <head>
        <title>Assista Platform</title>
        <meta
          name="description"
          content="Assista is an agent-computer interface platform that allows developers to easily connect AI with 3rd party software by tool-calling APIs."
        />
